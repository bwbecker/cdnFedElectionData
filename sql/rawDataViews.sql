...
*/
/*
-- Unused since final data for Election 43 is now out
...
DROP MATERIALIZED VIEW IF EXISTS _work.combined CASCADE;
CREATE MATERIALIZED VIEW _work.combined AS
(
SELECT *
FROM (
         SELECT *
...
REFRESH MATERIALIZED VIEW _work.combined;